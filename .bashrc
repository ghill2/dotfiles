...
alias g2c='code -n --folder-uri=vscode-remote://ssh-remote+g1@g2.local~/BU/projects/'
alias g3='ssh g1@g3.local'
alias g3c='code -n --folder-uri=vscode-remote://ssh-remote+g1@g3.local~/BU/projects/'
alias t2='ssh -t g1@t2 powershell'
alias t2c='code -n --folder-uri=vscode-remote://ssh-remote+g1@t2.local~/BU/projects/'
