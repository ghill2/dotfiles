...
function! s:splitNew(...)
    let file = a:2
    call s:split(a:1, file == '' ? '__vskcode_new__' : file)
endfunction
...
" End of Chris at machine mappings

map <S-L> 0 <CR>
map <S-K> $ <CR>

" Reload neovim https://github.com/vscode-neovim/vscode-neovim/issues/854
